...
SECRET_KEY = 'django-insecure-#8dye1#f=y86hg%(!wuc^t$*tb$luo+7l8gb^$^3-3k+vwa_it'
...
# Check if we are running on Render by looking for the DATABASE_URL environment variable.
